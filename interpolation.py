...
def main(model_name, input_file, output_file, input_dim, hidden_dim, latent_dim, output_dim, batch_size):
    # Set device
...
if __name__ == "__main__":
    ...
    main(args.model, args.input, args.output, args.input_dim, args.hidden_dim, args.latent_dim, args.output_dim, args.batch_size)
